...
const FilterGroup = ({className, title, inputType = "checkbox", options}: FilterGroupProps) => {
    return(
        <div className={`pb-3 px-6 lg:px-0 ${className}`}>
            {title && <h1 className="pb-3 text-sm font-bold text-dark-gray-2">{title}</h1>}
