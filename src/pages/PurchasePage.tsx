        ...
        <Layout>
            <div className="flex flex-col lg:flex-row lg:gap-4 justify-center pt-32 lg:pt-14 px-5 lg:px-0">
                ...
                <div className="lg:w-[30%] h-fit px-6 py-7 mt-5 lg:mt-14 bg-white">
                    ...
                    <NavLink to="/ecommerce-front/purchasedone" className="flex justify-center w-full py-2 px-2 bg-warning text-white rounded-md text-center">Realizar Pagamento</NavLink>
                </div>
            </div>     
