        ...
        <Section className='bg-light-gray-3'>
            ...
            <div className='flex gap-x-8 pb-20'>
                <div className='bg-white h-fit ml-10 px-5 py-6'>
                    ...
                    <FilterGroup title="Marca" inputType="checkbox" options={[{text:'Adidas', value:'adidas'}, {text:'Balenciaga', value:'balenciaga'}, {text:'K-Swiss', value:'K-Swiss'}, {text:'Nike', value:'Nike'}, {text:'Puma', value:'Puma'}]} />
